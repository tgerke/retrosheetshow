...
# Load packages for static examples
library(tibble)
library(dplyr)

# Create cache directory for examples
...
```{r gamelogs-example, eval = FALSE, cache = TRUE}
library(retrosheetshow)
library(dplyr)
...
```{r gamelogs-example-static, echo = FALSE}
# Static example for README (so it doesn't require download)
tribble(
  ...
  knitr::kable(caption = "Sample of 2023 Game Logs")
```

### Home Field Advantage Analysis

```{r home-advantage, eval = FALSE}
...
```{r home-advantage-static, echo = FALSE}
# Static result
tibble::tibble(
  total_games = 2430,
  home_wins = 1318,
...
tribble(
  ...
  knitr::kable(caption = "Sample of Yankees 2023 Roster")
```

### Top Winning Pitchers

```{r top-pitchers, eval = FALSE}
# Most wins in 2023
gamelogs |>
...
```{r top-pitchers-static, echo = FALSE}
tribble(
  ~pitcher, ~wins,
  "Webb,Logan", 15,
  "Gallen,Zac", 14,
  ...
  knitr::kable(caption = "Top 10 Winning Pitchers in 2023")
```
